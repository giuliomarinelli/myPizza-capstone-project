...
import { Component, ElementRef, ViewChild, afterNextRender, NgZone } from '@angular/core';
...
export class RegistratiComponent {
  ...
  constructor(private fb: FormBuilder, private authSvc: AuthService, private publicApiSvc: PublicApiService,
    private route: ActivatedRoute, private ngZone: NgZone, private router: Router) {
    afterNextRender(() => {
